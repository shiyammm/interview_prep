        ...
        <div className="bg-white relative">
            <div className="container mx-auto px-10 md:px-0">
                ...
                <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
                    <div className="w-16 h-16 bg-lime-400 blur-[65px] animate-spin" />
                    <div className="w-16 h-16 bg-teal-400 blur-[65px] animate-spin" />
                    <div className="w-16 h-16 bg-cyan-300 blur-[45px] animate-spin" />
                    <div className="w-16 h-16 bg-fuchsia-200 blur-[45px] animate-spin" />
                </div>
            </div>
        </div>
    );
